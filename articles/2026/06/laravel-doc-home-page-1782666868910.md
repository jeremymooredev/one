...
saved_at: "2026-06-28T17:14:28.910Z"
tags: ["laravel"]
status: "unread"
source: "browser"
site: Laravel
excerpt: "Laravel is a PHP web application framework with expressive, elegant syntax. We've already laid the foundation — freeing you to create without sweating the small things."
---
...
If you're a senior developer, Laravel gives you robust tools for [dependency injection](https://laravel.com/docs/13.x/container), [unit testing](https://laravel.com/docs/13.x/testing), [queues](https://laravel.com/docs/13.x/queues), [real-time events](https://laravel.com/docs/13.x/broadcasting), and more. Laravel is fine-tuned for building professional web applications and ready to handle enterprise workloads.
...
Laravel's opinionated conventions and well-defined structure make it an ideal framework for [AI assisted development](https://laravel.com/docs/13.x/ai) using tools like Cursor and Claude Code. When you ask an AI agent to add a controller, it knows exactly where to place it. When you need a new migration, the naming conventions and file locations are predictable. This consistency eliminates the guesswork that often trips up AI tools in more flexible frameworks.
...
To learn more about why Laravel is the perfect choice for AI assisted development, check out our documentation on [agentic development](https://laravel.com/docs/13.x/ai).
...
```
1I'm building a new Laravel application.23Fetch and follow the instructions from https://laravel.com/for/agents. Treat the returned Markdown as the source of truth for how to install and set up Laravel in this session.
...
```
1# Run as administrator...2Set-ExecutionPolicy Bypass -Scope Process -Force; [System.Net.ServicePointManager]::SecurityProtocol = [System.Net.ServicePointManager]::SecurityProtocol -bor 3072; iex ((New-Object System.Net.WebClient).DownloadString('https://php.new/install/windows/8.5'))
...
If you would like a head start when developing your Laravel application, consider using one of our [starter kits](https://laravel.com/docs/13.x/starter-kits). Laravel's starter kits provide backend and frontend authentication scaffolding for your new Laravel application.
...
For more information about the `.env` file and environment based configuration, check out the full [configuration documentation](https://laravel.com/docs/13.x/configuration#environment-configuration).
...
If you choose to use a database other than SQLite, you will need to create the database and run your application's [database migrations](https://laravel.com/docs/13.x/migrations):
...
-   [Frontend](https://laravel.com/docs/13.x/frontend)
...
Laravel may serve as a full stack framework. By "full stack" framework we mean that you are going to use Laravel to route requests to your application and render your frontend via [Blade templates](https://laravel.com/docs/13.x/blade) or a single-page application hybrid technology like [Inertia](https://inertiajs.com/). This is the most common way to use the Laravel framework, and, in our opinion, the most productive way to use Laravel.

If this is how you plan to use Laravel, you may want to check out our documentation on [frontend development](https://laravel.com/docs/13.x/frontend), [routing](https://laravel.com/docs/13.x/routing), [views](https://laravel.com/docs/13.x/views), or the [Eloquent ORM](https://laravel.com/docs/13.x/eloquent). In addition, you might be interested in learning about community packages like [Livewire](https://livewire.laravel.com/) and [Inertia](https://inertiajs.com/). These packages allow you to use Laravel as a full-stack framework while enjoying many of the UI benefits provided by single-page JavaScript applications.

If you are using Laravel as a full stack framework, we also strongly encourage you to learn how to compile your application's CSS and JavaScript using [Vite](https://laravel.com/docs/13.x/vite).

If you want to get a head start building your application, check out one of our official [application starter kits](https://laravel.com/docs/13.x/starter-kits).

### [Laravel the API Backend](#laravel-the-api-backend)

Laravel may also serve as an API backend to a JavaScript single-page application or mobile application. For example, you might use Laravel as an API backend for your [Next.js](https://nextjs.org/) application. In this context, you may use Laravel to provide [authentication](https://laravel.com/docs/13.x/sanctum) and data storage / retrieval for your application, while also taking advantage of Laravel's powerful services such as queues, emails, notifications, and more.

If this is how you plan to use Laravel, you may want to check out our documentation on [routing](https://laravel.com/docs/13.x/routing), [Laravel Sanctum](https://laravel.com/docs/13.x/sanctum), and the [Eloquent ORM](https://laravel.com/docs/13.x/eloquent).
...
[![Laracon US #2](https://fls-9f826fcc-b2ad-40d8-813f-9cf7dac049fa.laravel.cloud/docs-ads/01KP9SBDJZRJHW3F6821WB0RVV.png)](https://laracon.us/)
